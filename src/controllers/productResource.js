 ...
 */
var createProductResource = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                data = req.body.data;
                return [4 /*yield*/, prismaClient_1["default"].productResource.create({
                        data: data
                    })];
            case 1:
                result = _a.sent();
 ...
 */
var updateProductResource = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                data = req.body.data;
                return [4 /*yield*/, prismaClient_1["default"].productResource.update({
                        where: {
                            id: Number(id)
                        },
                        data: data
 ...
 * Delete productResources
 */
var deleteProductResource = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prismaClient_1["default"].productResource["delete"]({
                        where: {
                            id: Number(id)
                        }
                    })];
 ...
 */
var getProductResources = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var users, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prismaClient_1["default"].productResource.findMany({})];
            case 1:
                users = _a.sent();
                res.json(users);
                return [3 /*break*/, 3];
 ...
 */
var getProductResourceById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, post, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prismaClient_1["default"].productResource.findUnique({
                        where: { id: Number(id) }
                    })];
            case 1:
                post = _a.sent();
