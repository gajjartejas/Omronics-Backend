    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                data = req.body.data;
                return [4 /*yield*/, prismaClient_1["default"].product.create({
                        data: data
                    })];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                data = req.body.data;
                return [4 /*yield*/, prismaClient_1["default"].product.update({
                        where: {
                            id: Number(id)
                        },
                        data: data
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prismaClient_1["default"].product["delete"]({
                        where: {
                            id: Number(id)
                        }
                    })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prismaClient_1["default"].product.findUnique({
                        where: { id: Number(id) },
                        include: {
                            categories: true,
                            resourcees: true,
